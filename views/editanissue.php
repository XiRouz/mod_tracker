...
if ($data = $form->get_data()) {
    ...
    if (!$issue = tracker_editanissue($tracker, $data)) {
        print_error('errorcannoteditticket', 'tracker');
    ...
    // SAMSUNG BEGIN - no one is supposed to edit additional form elements, so we don't need to handle re-recording its values
